...
@Component({
  ...
  template: `
    <nb-auth-block>
      ...
      <small class="form-text sub-title">Ведите email, и вы будет отправлена ссылка для восстановления пароля</small>
      ...
      <div class="links col-sm-12">
        <small class="form-text">
          Уже зарегистрированы? <a routerLink="../login"><strong>Войти</strong></a>
        </small>
        <small class="form-text">
          <a routerLink="../register"><strong>Зарегистрироваться</strong></a>
        </small>
      </div>
    </nb-auth-block>
  `,
